...
st.markdown('<h2 style="color: white; text-align: center;font-family: verdana">movies industry analysis and coorelations</h2>', unsafe_allow_html=True)

st.markdown('''<p style="font-weight:bold; font-size: 20px; font-family:cursive" Movie industry analysis involves examining various aspects of the film industry to understand its dynamics, trends, and factors influencing its performance. This analysis typically includes
